      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {contactInfo.map((info, index) => {
            ...
            const CardComponent = (
              <motion.div
                ...
                className="h-full"
              >
                <Card className="hover:shadow-2xl transition-all duration-500 border-2 hover:border-primary group bg-card h-full relative overflow-hidden">
                  {/* Background Pattern */}
                  ...
                  <CardContent className="p-6 text-center relative z-10 h-full flex flex-col">
                    ...
                    <div className="relative mb-4">
                      ...
                      {/* Decorative ring */}
                      <div className="absolute inset-0 w-18 h-18 mx-auto rounded-2xl border-2 border-primary/20 group-hover:border-primary/40 transition-colors duration-500 animate-pulse" />
                    </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Card className="overflow-hidden border-2 hover:border-primary transition-all duration-500 bg-card hover:shadow-xl group">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Card className="border-2 hover:border-primary transition-all duration-500 bg-card hover:shadow-xl">
