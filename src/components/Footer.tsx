      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="border-t border-gray-800 pt-6 md:pt-8 lg:pt-10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 lg:gap-6">
            ...
            <button 
              className="flex items-center gap-2 px-4 py-2 lg:px-6 lg:py-3 bg-gray-800 hover:bg-[#F9B800] text-gray-400 hover:text-black transition-all duration-300 rounded-lg group hover:scale-105"
              onClick={() => alert('Admin panel akan segera tersedia')}
            >
              <Lock size={16} className="group-hover:rotate-12 transition-transform lg:w-5 lg:h-5" />
              <span className="text-sm lg:text-base font-medium">Admin</span>
            </button>
          </div>
        </div>
      </div>
