...
import alumniImage from "figma:asset/6b46a27e0b8399c691eb586316a2d6085b7df0cd.png";
import trainingGroupImage from "figma:asset/9da627e546ddb1d2d003e95f1b7516463b567b7f.png";
import energizerTrainingImage from "figma:asset/99e0314e50abcdabe9b4135bec2ede23a8211cb4.png";
import certificateCeremonyImage from "figma:asset/0e18d11cd3b78c91ef6d12cfc6e9dbd470601d90.png";
import radioStationImage from "figma:asset/62411ba469e74f21534b7dee2c501918a152ca14.png";
      ...
      const defaultImages: GalleryImage[] = [
        {
          ...
          alt: "Peserta training Swaragama mengangkat tangan dengan antusias",
          caption: "Energizer & Ice Breaking Session",
        },
        {
          src: trainingGroupImage,
          alt: "Tim training Swaragama - Diskusi kelompok yang antusias",
          caption: "Suasana Training Interaktif",
        },
        {
          src: radioStationImage,
          alt: "Pelatihan Broadcaster di Swaragama FM 101.7 dengan peserta bersertifikat",
          caption: "Program Broadcaster - Swaragama FM 101.7",
        },
        {
          src: certificateCeremonyImage,
          alt: "Peserta training Swaragama membanggakan sertifikat mereka",
          caption: "Certificate Ceremony - Graduation Day",
        },
        {
          src: alumniImage,
          alt: "Alumni Swaragama Training Center",
          caption: "Alumni Success Story",
        },
      ];

      // Use default images
      const combinedImages = defaultImages;
        ...
        <div className="space-y-16">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="bg-card p-8 rounded-xl border border-border h-fit">
            ...
            >
              ...
              <TabsContent value="about" className="space-y-6">
                <div className="bg-card p-8 rounded-xl border border-border">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {[
                        ...
                        <motion.div
                          ...
                          viewport={{ once: true }}
                          className="flex items-center space-x-3 p-3 bg-green-50 dark:bg-green-950/30 rounded-lg hover:bg-green-100 dark:hover:bg-green-950/50 transition-colors duration-300"
                        >
                  ...
                  <div className="mt-8 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-950/30 dark:to-blue-900/30 p-6 rounded-lg border border-blue-200 dark:border-blue-800">
