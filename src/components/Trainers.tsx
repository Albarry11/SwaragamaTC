        ...
        <div className="relative group">
          ...
          >
            {trainers.map((trainer, index) => (
              ...
              >
                {/* Modern Fresh Card Design */}
                <div className="relative bg-card border border-border/60 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-1 hover:border-primary/20 h-[450px] flex flex-col">
                  {/* Clean Image Container */}
                  <div className="relative h-80 overflow-hidden bg-muted/30 flex-shrink-0">
                    {trainer.image ? (
                      <img
                        src={trainer.image}
                        alt={trainer.name}
                      ...
                      <div className="w-full h-full bg-gradient-to-br from-primary/15 via-primary/8 to-primary/5 flex items-center justify-center group-hover:scale-105 transition-all duration-500">
                        <div className="text-center">
                          <div className="w-16 h-16 bg-primary/15 rounded-2xl flex items-center justify-center mb-3 mx-auto backdrop-blur-sm border border-primary/20">
                    ...
                    {/* Subtle overlay */}
                    <div className="absolute inset-0 bg-gradient-to-t from-black/20 via-transparent to-transparent opacity-60 group-hover:opacity-30 transition-opacity duration-500" />
                  </div>
